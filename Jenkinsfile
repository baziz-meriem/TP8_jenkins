...
steps {
   ...
   junit 'build/test-results/test/TEST-Matrix.xml'
      ...
      steps {
        slackSend(baseUrl: 'https://hooks.slack.com/services', channel: '#tp', notifyCommitters: true, sendAsText: true, message: 'Slack vous indique que le processus est termine avec succes. ', replyBroadcast: true,token: 'fZ277hMOuSOeYlGmZnMjfGsK')
      }
    }
